...
public class vTrabajador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 30, 200, -1));
        ...
        jPanel1.add(cmbTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 200, -1));
        ...
        jPanel1.add(txtNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 200, -1));
        ...
        jPanel1.add(txtIdPersona, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 260, 200, -1));

        jLabel2.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel2.setText("El ID se almacenara en la BD");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, -1, -1));
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 180, 210, 50));
        ...
        jPanel1.add(btnNuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 60, 210, 40));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 120, 210, 40));
        ...
        jPanel2.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 290, -1));
        ...
        jPanel2.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 20, 190, -1));
        ...
        jPanel2.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 20, 180, -1));

        lbltotalregistros.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        lbltotalregistros.setText("Registros");
        jPanel2.add(lbltotalregistros, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 530, -1, -1));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 1190, 210));

        lbltotalregistros1.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        lbltotalregistros1.setText("Registros:");
        jPanel2.add(lbltotalregistros1, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 20, -1, 30));
        ...
        jPanel1.add(txtApaterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 200, -1));
        ...
        jPanel1.add(txtAmaterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 200, -1));
        ...
        jPanel1.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 200, -1));
        ...
        jPanel1.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 200, -1));
        ...
        jPanel1.add(txtSueldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 50, 200, -1));
        ...
        jPanel1.add(cmbAcceso, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 90, 200, -1));
        ...
        jPanel1.add(txtLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 170, 200, -1));

        jLabel15.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel15.setText("Login:");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 170, -1, -1));
        ...
        jPanel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 210, 200, -1));

        jLabel16.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel16.setText("Password:");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 210, -1, -1));

        cmbEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "D" }));
        cmbEstado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbEstadoActionPerformed(evt);
            }
        });
        jPanel1.add(cmbEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 130, 200, -1));

        jLabel17.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        jLabel17.setText("Estado:");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 130, -1, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtNombre.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa un nombre para el Trabajador Por Favor");
            txtNombre.requestFocus();
            return;
        }
         if (txtApaterno.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa un apellido paterno para el Trabajador Por Favor");
            txtApaterno.requestFocus();
            return;
        }
        if (txtAmaterno.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa un apellido materno para el Trabajador Por Favor");
            txtAmaterno.requestFocus();
            return;
        }
        if (txtNumero.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Establece el numero de documento del Trabajador Por favor");
            txtNumero.requestFocus();
            return;
        }
        if (txtSueldo.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Establece el sueldo del Trabajador Por favor");
            txtSueldo.requestFocus();
            return;
        }
        if (txtLogin.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa un login para el Trabajador Por favor");
            txtLogin.requestFocus();
            return;
        }
        if (txtPassword.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa un password para el Trabajador Por favor");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
            if (!txtIdPersona.getText().equals("")) {
                int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Estas seguro de que quieres Eliminar el Trabajador?","Confirmar",2);
    ...
    private void tblRegistroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMouseClicked
        ...
        txtSueldo.setText(tblRegistro.getValueAt(fila, 9).toString());
        cmbAcceso.setSelectedItem(tblRegistro.getValueAt(fila, 10).toString());
        txtLogin.setText(tblRegistro.getValueAt(fila, 11).toString());
        txtPassword.setText(tblRegistro.getValueAt(fila, 12).toString());
        cmbEstado.setSelectedItem(tblRegistro.getValueAt(fila, 13).toString());
